...
- 使い方ガイド(操作・コツ・作例): [docs/guide.md](docs/guide.md)
...
**使い方の詳しい解説・コツ・作例は [使い方ガイド(docs/guide.md)](docs/guide.md) にまとめています。** 以下は早見表です。

- **描画**: ドラッグで描く(マウスは速度→擬似筆圧、タブレットは実筆圧)
- **ブラシ**(右インスペクタ / キー): `1` 水彩(藍) / `2` 墨(かすれ — 軽く/速く描くほどかすれが強くなる)、カラーウェルで任意色、サイズ `[` `]`、水量スライダ、`c` クリア、`d` デモストローク
